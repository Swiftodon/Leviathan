...
#if TARGET_OS_IPHONE
+(id<MAIFontProtocol>)preferredFontForTextStyle:(UIFontTextStyle)style NS_UNAVAILABLE;
+(id<MAIFontProtocol>)preferredFontForTextStyle:(UIFontTextStyle)style compatibleWithTraitCollection:(nullable UITraitCollection*)traitCollection NS_UNAVAILABLE;
